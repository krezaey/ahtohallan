...
const semanticErrors = [
  ...
  ['non-boolean short if test', 'Get~This~Right(1 ❅) {}', /a booley, found int/],
  ['non-boolean if test', 'Get~This~Right(1 ❅) {} Into~The~Unknown {}', /a booley, found int/],
  ['non-boolean while test', 'Lost~In~The~Woods(1 ❅) {}', /a booley, found int/],
  ['bad types for ||', 'Sing(Hans||1) ❅', /a booley, found int/],
  ['bad types for &&', 'Sing(Hans&&1) ❅', /a booley, found int/],
  ['bad types for ==', 'Sing(Hans==1) ❅', /Excuse me old spirit, it appears that your declared variable type and your chosen expression are not the same! How embarrassing!/],
  ['bad types for !=', 'Sing(Hans!=1) ❅', /Excuse me old spirit, it appears that your declared variable type and your chosen expression are not the same! How embarrassing!/],
  ['bad types for +', 'Sing(Hans+1) ❅', /Expected a number or string, found booley/],
  ['bad types for -', 'Sing(Hans-1) ❅', /a number, found booley/],
  ['bad types for *', 'Sing(Hans*1) ❅', /a number, found booley/],
  ['bad types for /', 'Sing(Hans/1) ❅', /a number, found booley/],
  ['bad types for **', 'Sing(Hans**1) ❅', /a number, found booley/],
  ['bad types for <', 'Sing(Hans<1) ❅', /Expected a number or string, found booley/],
  ...
  ['bad types for negation', 'Sing(-Kristoff) ❅', /a number, found booley/],
  ['bad types for not', 'Sing(!"hello") ❅', /a booley, found string/],
