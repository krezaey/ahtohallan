...
const goodPrograms = [
    ...
    'All~Is~Found(expression ❅) { Show~Yourself(cHans): ~* Code block for case 1 here *~ Closed~Door ❅ Show~Yourself(Kristoff): ~* Code block for case 2 here *~ Closed~Door ❅ I~Seek~The~Truth:  ~* Code block for the default here *~  Closed~Door ❅ }', "~* This is   a comment  *~", "~* This * is also * a comment *~"
]
